---
title: "Lecture 9: Effect Modification (Interactions) and Logistic regression"
...
There was a significant improvement to the constant only model. Nagelkerke R2 = 4.8% of the variation in malaise can be explained by the model including gender.
